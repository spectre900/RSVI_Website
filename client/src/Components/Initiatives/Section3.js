...
const Section3 = () => {
  const [classTab, setClass] = useState(true);
  const setTabClass = () => {
    classTab === true ? setClass(false) : setClass(true);
  };
  const HideTab = () => {
    setClass(true);
  };
    ...
    <div id="work2@Home">
      <div className={Styles.allover}>
        ...
        <Tabs className={Styles.alloverr}>
          <TabList className={classTab === true ? Styles.Tabs : Styles.tab}>
            <Tab onClick={HideTab}>Rail Concession</Tab>
            <Tab onClick={HideTab}>Eyes & Health Checkup</Tab>
            <Tab onClick={HideTab}>Old Age Support</Tab>
            <Tab onClick={HideTab}>Aids & Appliances center</Tab>
            <Tab onClick={HideTab}>Exposure After Training</Tab>
          </TabList>
